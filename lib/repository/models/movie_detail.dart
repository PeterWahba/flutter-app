...
class Video {
  ...
  Video.fromJson(Map<String, dynamic> json)
      : index = json['index']?.toString(),
        ...
        colorRange =
            json['color_range']?.toString(),
        colorSpace =
            json['color_space']?.toString(),
